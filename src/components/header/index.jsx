  ...
  return (
    <header className="app-header">
      <nav className="header-nav">
        <Link to="/" className="header-logo-link" aria-label="Página inicial do Sapientia">
          <h1 className="header-title">Sapientia</h1>
        </Link>
        <button onClick={handleLogout} className="header-logout-button" aria-label="Sair da sua conta">
          Sair
        </button>
      </nav>
    </header>
